...
<head>
    ...
    <title>Admin Login — GameShop</title>
...
<body class="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="mt-3 text-3xl font-bold text-white tracking-tight">Admin Panel</h1>
            <p class="mt-1 text-zinc-500 text-sm">Restricted access — administrators only</p>
        </div>
